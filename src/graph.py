...
def zeropad(x):
    """ 
    zeropad y zeropad_output_shapes son de
...
def ECG_model(config):
    """ 
    la implementación del modelo en https://www.nature.com/articles/s41591-018-0268-3 
 también tiene referencia a los códigos en 
 https://github.com/awni/ecg/blob/master/ecg/network.py 
 y 
